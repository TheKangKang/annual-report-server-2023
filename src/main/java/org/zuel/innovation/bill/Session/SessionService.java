...
public class SessionService extends BaseService<Session> {
     ...
     */
    public Session add(String userId, int type, int gender, int identity) {
        Session userSession = new Session();
        userSession.setUserId(Integer.valueOf(userId));
        userSession.setSessionId(Kits.getUuid());
        userSession.setType(String.valueOf(type));
        userSession.setSex(String.valueOf(gender));
        userSession.setIdentity(String.valueOf(identity));
